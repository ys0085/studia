...
SELECT f.title, l.name 
    -> FROM film f INNER JOIN language l ON l.language_id=f.language_id
...
12. 
SELECT LEAST(fa1.actor_id, fa2.actor_id) AS actor1_id, GREATEST(fa1.actor_id, fa2.actor_id) AS actor2_id, COUNT(*) AS shared_movies
FROM film_actor fa1
...
FROM customer c
JOIN average_per_customer ac
ON c.customer_id = ac.customer_id
JOIN average_per_day ad 
